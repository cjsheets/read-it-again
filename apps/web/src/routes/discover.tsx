    ...
    <section aria-labelledby="discover-title">
      ...
      {empty ? (
        <div className="empty" data-testid="discover-empty">
          ...
          <p>
            Suggestions are generated by the local runtime, which can search the library catalog.
            This app cannot reach a catalog from a browser, so it receives them inside an encrypted
            backup. Run <code>pnpm bookshelf sync</code> on your computer, then restore the backup
            under Settings.
          </p>
        </div>
      ) : (
